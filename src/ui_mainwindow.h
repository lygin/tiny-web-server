...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pathPushBotton->setGeometry(QRect(630, 120, 25, 20));
        pathPushBotton->setMinimumSize(QSize(25, 0));
        pathPushBotton->setMaximumSize(QSize(25, 16777215));
        ...
        startPushBotton->setGeometry(QRect(520, 20, 161, 41));
